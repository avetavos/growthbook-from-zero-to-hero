...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      head: [
        { tag: 'script', attrs: { type: 'module', src: '/growthbook/enhance.js' } },
        { tag: 'link', attrs: { rel: 'manifest', href: '/growthbook/manifest.webmanifest' } },
        { tag: 'link', attrs: { rel: 'apple-touch-icon', href: '/growthbook/apple-touch-icon.png' } },
        { tag: 'link', attrs: { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/growthbook/icon-192.png' } },
        ...
        { tag: 'script', content: "if('serviceWorker' in navigator){window.addEventListener('load',function(){navigator.serviceWorker.register('/growthbook/sw.js',{scope:'/growthbook/'}).catch(function(){})})}" },
      ],
      defaultLocale: 'en',
      locales: {
