...
export const pipelineDiagram = `flowchart TD
...
<Mermaid code={pipelineDiagram} title="GrowthBook เข้ากับ stack ของคุณอย่างไร" />
...
GrowthBook เป็น platform แบบ "bring your own data" — GrowthBook query warehouse ของคุณโดยตรง raw events และข้อมูลผู้ใช้ไม่เคยออกจาก infrastructure ของคุณ คุณยังคงเป็นเจ้าของและควบคุมข้อมูลได้อย่างเต็มที่
</Callout>
...
export const quizMetricsIndex = [
  ...
  },
  {
    ...
    options: [
      'เพิ่มผู้ใช้ใหม่เข้าสู่ experiment',
      'บอก GrowthBook ว่าผู้ใช้คนไหนเห็น variation ไหน และเมื่อไหร่',
      'กำหนดว่า metrics ใดที่ต้องติดตาม',
      'deploy feature flag ไปยัง production',
    ],
    answer: 1,
  },
  {
