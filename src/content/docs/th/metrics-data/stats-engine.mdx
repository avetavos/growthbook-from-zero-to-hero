...
> 💡 ตัวอย่างจากของจริง
>
> ทีม data science ขนาดใหญ่มักเลือก Frequentist เพราะ auditor หรือ stakeholder ภายนอกคุ้นเคยกับ p-value มากกว่า ส่วนทีม product ทั่วไปชอบ Bayesian "chance to win" เพราะสื่อสารง่ายกว่า
...
export const quizStatsEngine = [
  ...
  },
  {
    ...
    options: [
      'แบ่ง traffic ระหว่าง variations',
      'ลด metric variance โดยใช้ pre-experiment data ทำให้ confidence intervals แคบลง',
      'รัน assignment query เร็วขึ้น',
      'ตรวจสอบว่า guardrail metrics ไม่ถดถอย',
    ],
    answer: 1,
  },
  {
