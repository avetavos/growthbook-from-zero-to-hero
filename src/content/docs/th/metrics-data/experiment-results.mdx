...
การดูผลก่อนกำหนดและตัดสินใจเมื่อ sample size ยังน้อยเรียกว่า "peeking" — ทำให้ false positive rate เพิ่มขึ้นอย่างมาก ให้ experiment รันถึง sample size หรือระยะเวลาที่วางแผนไว้ก่อนสรุปผล ใช้ sequential testing option ของ GrowthBook ถ้าต้องการดูผลระหว่างทางอย่างปลอดภัย
</Callout>
...
> 💡 ตัวอย่างจากของจริง
>
> ทีม growth มักมีกฎห้าม ship ผล experiment ที่ยังไม่ถึง statistical significance ไม่ว่าผลจะดูดีแค่ไหนก็ตาม
...
export const quizExperimentResults = [
  ...
  },
  {
    ...
    options: [
      'เป็น primary goal ที่ experiment กำลัง optimize',
      'เป็น metric ที่ต้องไม่ถดถอย — คอย flag การถดถอยแม้ goal metrics จะดูดี',
      'ควบคุม traffic split ระหว่าง variations',
      'ตั้งระยะเวลา experiment ขั้นต่ำ',
    ],
    answer: 1,
  },
  {
