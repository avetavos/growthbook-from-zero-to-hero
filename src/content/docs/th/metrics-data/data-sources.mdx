...
Assignment query เป็น query ที่สำคัญที่สุดใน GrowthBook เพราะเป็นตัวตอบคำถามที่ว่า: _"ผู้ใช้คนไหนเห็น experiment variation ไหน และเมื่อไหร่?"_
...
Experiment assignment query บอก GrowthBook ว่าผู้ใช้คนไหนเห็น variation ไหน และเมื่อไหร่ metric ทุกตัวและผล statistical ทั้งหมดมาจาก query นี้ — ถ้า query ผิดหรือไม่ครบถ้วน การวิเคราะห์ทั้งหมดจะผิดด้วย ตรวจสอบด้วย SQL preview โดยตรงก่อน save
</Callout>
...
> 💡 ตัวอย่างจากของจริง
>
> บริษัทที่ใช้ Snowflake หรือ BigQuery ภายในอยู่แล้วมักเลือก GrowthBook เพราะเชื่อมกับ warehouse เดิมได้ตรง ไม่ต้อง duplicate data ไปที่ระบบใหม่
