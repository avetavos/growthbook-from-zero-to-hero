...
> 💡 ตัวอย่างจากของจริง
>
> ทีม security ที่บริษัทขนาดใหญ่มักบังคับให้ secret ทุกตัวผ่าน secret manager (เช่น AWS Secrets Manager, Vault) ไม่ใช่เก็บใน `.env` file ธรรมดาสำหรับ production
