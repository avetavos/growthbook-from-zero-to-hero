...
|---|---|---|
| Client-side SDK | real-time, personalize ตาม browser ได้ทันที | user เห็น flag values ผ่าน dev tools ได้ ไม่ควรใช้กับ business-critical secret |
| Server-side rendering ของ flag | ซ่อน logic จาก client ได้ | ต้องเพิ่ม server round-trip ก่อนแสดงผล |
